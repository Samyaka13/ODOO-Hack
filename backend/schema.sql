...
INSERT INTO public.users (id, username, password_hash, email, avatar, bio, registration_date) VALUES
(1, 'john_doe', 'hashed_password_1', 'john@example.com', 'avatar1.png', 'Bio of John Doe', '2025-01-01'),
(2, 'jane_smith', 'hashed_password_2', 'jane@example.com', 'avatar2.png', 'Bio of Jane Smith', '2025-02-01');

INSERT INTO public.subthreads (id, name, description, created_at, logo, created_by) VALUES
(1, 'TechTalk', 'A subthread for tech enthusiasts', '2025-03-01', 'logo1.png', 1),
(2, 'Foodies', 'A subthread for food lovers', '2025-03-02', 'logo2.png', 2);

INSERT INTO public.posts (id, user_id, subthread_id, title, media, content, created_at, is_edited) VALUES
(1, 1, 1, 'Latest Tech Trends', 'media1.png', 'Content about tech trends', '2025-04-01', false),
(2, 2, 2, 'Best Recipes', 'media2.png', 'Content about recipes', '2025-04-02', false);

INSERT INTO public.comments (id, user_id, post_id, parent_id, has_parent, content, created_at, is_edited) VALUES
(1, 1, 1, NULL, false, 'Great post about tech!', '2025-04-03', false),
(2, 2, 2, NULL, false, 'Love these recipes!', '2025-04-04', false);

INSERT INTO public.reactions (id, user_id, post_id, comment_id, is_upvote, created_at) VALUES
(1, 1, 1, NULL, true, '2025-04-05'),
(2, 2, NULL, 1, true, '2025-04-06');

INSERT INTO public.subscriptions (id, user_id, subthread_id, created_at) VALUES
(1, 1, 1, '2025-04-07'),
(2, 2, 2, '2025-04-08');